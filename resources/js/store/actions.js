...
export const addProductToCart = ({ commit }, { product, quantity, price ,avilableTarget , sizeTarget}) => {
  commit("ADD_TO_CART", { product, quantity, price,avilableTarget , sizeTarget });
