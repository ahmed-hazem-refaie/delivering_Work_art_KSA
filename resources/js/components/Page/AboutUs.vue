  ...
  <section>
    ...
    <div class="ourteam mt-4">
      ...
      <div class="row text-center mt-5 topteam" v-if="team">
        ...
        <div class="col-sm-12 col-lg-4">
          <div class="about-team__people">
            <img
              src="//cdn.shopify.com/s/files/1/3000/4362/files/Untitled-3_400x.png?v=1581493308"
              alt
            />
      ...
      <div class="row text-center mt-5 midteam" v-if="team">
        <div class="col-sm-4 col-lg-2">
          <div class="about-team__people">
            <img
              src="//cdn.shopify.com/s/files/1/3000/4362/files/team_0000_Dragana_400x.png?v=1565170625"
              alt
            />
        ...
        <div class="col-sm-4 col-lg-2">
          <div class="about-team__people">
            <img
              src="//cdn.shopify.com/s/files/1/3000/4362/files/team_0001_Rezyl_400x.png?v=1565170678"
              alt
            />
        ...
        <div class="col-sm-4 col-lg-2">
          <div class="about-team__people">
            <img
              src="//cdn.shopify.com/s/files/1/3000/4362/files/team_0006_Clyde_400x.png?v=1565170724"
              alt
            />
        ...
        <div class="col-sm-4 col-lg-2">
          <div class="about-team__people">
            <img
              src="//cdn.shopify.com/s/files/1/3000/4362/files/team_0007_Tanya_400x.png?v=1565171102"
              alt
            />
        ...
        <div class="col-sm-4 col-lg-2">
          <div class="about-team__people">
            <img
              src="//cdn.shopify.com/s/files/1/3000/4362/files/team_0004_Luka_400x.png?v=1565170762"
              alt
            />
        ...
        <div class="col-sm-4 col-lg-2">
          <div class="about-team__people">
            <img
              src="//cdn.shopify.com/s/files/1/3000/4362/files/team_0002_Samantha_400x.png?v=1565170801"
              alt
            />
        ...
        <div class="col-sm-4 col-lg-2">
          <div class="about-team__people">
            <img
              src="//cdn.shopify.com/s/files/1/3000/4362/files/team_0003_Ioanna_400x.png?v=1565170524"
              alt
            />
        ...
        <div class="col-sm-4 col-lg-2">
          <div class="about-team__people">
            <img
              src="//cdn.shopify.com/s/files/1/3000/4362/files/team_0009_Sarah_400x.png?v=1565170549"
              alt
            />
        ...
        <div class="col-sm-4 col-lg-2">
          <div class="about-team__people">
            <img
              src="//cdn.shopify.com/s/files/1/3000/4362/files/team_0010_Ieva_400x.png?v=1565170589"
              alt
            />
        ...
        <div class="col-sm-4 col-lg-2">
          <div class="about-team__people">
            <img
              src="//cdn.shopify.com/s/files/1/3000/4362/files/team_0005_Sinisa_400x.png?v=1565170840"
              alt
            />
        ...
        <div class="col-sm-4 col-lg-2">
          <div class="about-team__people">
            <img
              src="//cdn.shopify.com/s/files/1/3000/4362/files/team_0012_Tran_400x.png?v=1565171725"
              alt
            />
    ...
    <div class="support mt-4">
      ...
      <div class="mt-5" v-if="support">
        <p
          class="text-center"
        >Do you have any questions? Have a look at the categories below, and if these don't include the answer you were looking for, please feel free to shoot us an email.</p>
          ...
          <div class="col-sm-12" v-if="active_el==1">
            <div class="row">
              <div class="col-sm-5 text-center left">
                ...
                >What are the exact dimensions/materials of my artwork?</p>
