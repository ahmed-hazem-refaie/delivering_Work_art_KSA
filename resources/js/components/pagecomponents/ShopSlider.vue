    ...
    <div class="container-fluid">
        ...
        <div class="swiper-container mt-5">
            <div class="swiper-wrapper">
              <div class="swiper-slide ml-1" v-for="data in data" :key="data.id">
                <div class="product-grid-item">
                    ...
                    <div class="product-grid-item__info">
                        ...
                        <span class="product-grid-item__qty"><span class="prints-times text-success">{{data.palette_copies}} / </span><span class="black">{{data.avalible_copies}} left</span></span>
                    </div>
                </div>
              </div>
            </div>
